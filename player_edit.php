    ...
    <div class="row">
        ...
        <div class="span12 gallery">
            <h3 class="title-bg">Players
                <a style="float: right;" href="player_detail_add.php">Add</a>
            </h3>

            <div class="row clearfix">
                <ul class="gallery-post-grid holder">
                <?php
                    foreach($result as $cauthu) {
                ?>

                    <!-- Gallery Item 1 -->
                    <li  class="span2 gallery-item" data-id="id-1" data-type="illustration">
                        <a href="player_detail_edit.php?&id=<?php echo $cauthu['MSCAUTHU'] ?>"><img src="img/player/<?php echo $cauthu['HINHANH'] ?>" alt="Player"></a>
                        <span class="project-details"><a href="player_detail_edit.php?&id=<?php echo $cauthu['MSCAUTHU'] ?>"><?php echo $cauthu['TENCAUTHU'] ?></a>Club: &ensp;<img src="img/bigLogo/<?php echo $cauthu['LOGO'] ?>" width="20px" height="20px"><br>Nationality: &ensp;<img src="img/nationality/<?php echo $cauthu['FLAG'] ?>" width="18px" height="12px"></span>
                    </li>
                <?php
                }
                ?>
            ...
            <div class="pagination">
                ...
                ?>
                <li><a href="player_edit.php?&page=<?php echo $_GET['page']-1 ?>">Prev</a></li>
                <?php
                }
                ?>
                <?php
                    $sql_page = $db->query("SELECT * FROM cauthu");
                    $count = $sql_page->rowCount($sql_page);
                    $a = ceil($count/18);
                    for($b=1; $b<=$a; $b++){
                ?>
                <?php
                if($get_page==$b){
                ?>
                <li class="active"><a href="player_edit.php?&page=<?php echo $b ?>"><?php echo $b ?></a></li>
                <?php
                }else if($get_page==''){
                ?>
                <li><a href="player_edit.php?&page=<?php echo $b ?>"><?php echo $b ?></a></li>
                <?php
                }else{
                ?>
                <li><a href="player_edit.php?&page=<?php echo $b ?>"><?php echo $b ?></a></li>
                ...
                if($get_page==''){
                ?>
                <li><a href="player_edit.php?&page=<?php echo $c; ?>">Next</a></li>
                <?php
                }else if($get_page==$a){
                ?>
                ...
                ?>
                <li><a href="player_edit.php?&page=<?php echo $_GET['page']+1 ?>">Next</a></li>
                <?php
                }
                ?>
