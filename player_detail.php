      ...
      <div class="row header"><!-- Begin Header -->
        ...
        ?>
            ...
            <div class="row">
                ...
                <div class="span7">
                    <h2><?php echo $cauthu['TENCAUTHU'] ?></h2>

                    <ul class="project-info">
                        <li><h6>Nationality:</h6> <img src="img/nationality/<?php echo $cauthu['FLAG'] ?>" width="30px" height="20px">&ensp; <?php echo $cauthu['QUOCTICH'] ?></li>
                        <li><h6>Club:</h6> <img src="img/bigLogo/<?php echo $cauthu['LOGO'] ?>" width="25px" height="25px" > &ensp;<?php echo $cauthu['TENCLB'] ?></li>
                        <li><h6>Position:</h6> <?php echo $cauthu['VITRI'] ?></li>
                        <li><h6>Number:</h6> <?php echo $cauthu['SOAO'] ?></li>
                        <li><h6>Age:</h6> <?php echo $cauthu['tuoi'] ?></li>
                        <li><h6>Date of birth:</h6> <?php echo $cauthu['day']."/".$cauthu['month']."/".$cauthu['year'] ?></li>
                        <li><h6>Height:</h6> <?php echo $cauthu['CHIEUCAO'] ?></li>
                    </ul>
