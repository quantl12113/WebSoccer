...
?>
    ...
    <div class="row">
        ...
        $sql_scorer = "SELECT *
            FROM dsghiban,cauthu,clb,quoctich
            WHERE dsghiban.\"MSCAUTHU\" = cauthu.\"MSCAUTHU\"
            AND cauthu.\"MSCLB\" = clb.\"MSCLB\"
            AND cauthu.\"QUOCTICH\" = quoctich.\"QUOCTICH\"
            ORDER BY dsghiban.\"SOBANTHANG\" DESC
            LIMIT 20 OFFSET 0";
            $sth=$db->prepare($sql_scorer);
        ...
        ================================================== --> 
        <div class="span12">
            <h3 class="title-bg">Top Scorers</h3>
                <div id="clientCarousel" class="carousel slide no-margin">
                <div class="span1"><h4><u>Rank</u></h4></div>
                <div class="span3"><h4><u>Player</u></h4></div>
                <div class="span3"><h4><u>Club</u></h4></div>
                <div class="span3"><h4><u>Nationality</u></h4></div>
                <div class="span1" align="center"><h4><u>Stat</u></h4></div>       

                <?php
                foreach($result as $scorer) {   
                ?>
                <div class="span1"><h4><?php $n = $n + 1; echo($n) ?></h4></div>
                <div class="span3"><h5><a href="player_detail.php?&id=<?php echo $scorer['MSCAUTHU'] ?>"><img src="img/player/<?php echo $scorer['HINHANH'] ?>" width="50px" height="50px"></a> <?php echo $scorer['TENCAUTHU'] ?></h5></div>
                <div class="span3"><h5><a href="club_info.php?&id=<?php echo $scorer['MSCLB'] ?>"><img src="img/bigLogo/<?php echo $scorer['LOGO'] ?>" width="35px" height="35px"></a> <?php echo $scorer['TENCLB'] ?></h5></div>
                <div class="span3"><h5><img src="img/nationality/<?php echo $scorer['FLAG']?>" width="45px" height="30px"> <?php echo $scorer['QUOCTICH'] ?></h5></div>
                <div class="span1" align="center"><h4><?php echo $scorer['SOBANTHANG'] ?></h4></div>
