    ...
    <!-- Title Header -->
        <div class="span8"><!--Begin page content column-->
            ...
            <article class="clearfix">
                <a href="blog-single.htm"><img src="img/bigLogo/mnuLogo.png" alt="Post Thumb" class="align-left"></a>
                <div class=span5>
                <h1 class="title-bg">Manchester United</a></h1>
                    <p><i class="icon-map-marker"></i>Stadium: Old Trafford </p>
                    <p><i class="icon-time"></i>Founded: 1878 </p>
                    <p><i class="icon-envelope"></i>Contact: (0) 161 868 8000</p>
                    <p><i class="icon-home"></i>Offical Website:<a href="www.manutd.com"> www.manutd.com</a></p>
        ...
        <div class="span4 sidebar page-sidebar"><!-- Begin sidebar column -->
            ...
            <p class="quote-text side">"Lorem ipsum dolor sit amet, consectetur adipiscing elit. In interdum felis fermentum ipsum molestie sed porttitor ligula rutrum. Morbi blandit ultricies ultrices. Vivamus nec lectus sed orci molestie molestie."<cite>- Client Name, Big Company</cite></p>
        
            <p class="quote-text side">"Adipiscing elit. In interdum felis fermentum ipsum molestie sed porttitor ligula rutrum. Morbi blandit ultricies ultrices. Vivamus nec lectus sed orci molestie molestie."<cite>- Another Client Name, Big Company</cite></p>
