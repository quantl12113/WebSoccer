            ...
            <div class="row clearfix">
                ...
                ?>
                    ...
                    <li  class="span2 gallery-item" data-id="id-1" data-type="illustration">
                        <a href="referee_profile.php?&id=<?php echo $ref['MSTRONGTAI'] ?>"><img src="img/referee/<?php echo $ref['HINHANH'] ?>" alt="Referees"></a>
                        <span class="project-details"><a href="referee_profile.php?&id=<?php echo $ref['MSTRONGTAI'] ?>"><?php echo $ref['TENTRONGTAI'] ?></a>Nationality: &ensp;<img src="img/nationality/<?php echo $ref['FLAG'] ?>" width="27px" height="18px"></span>
                    </li>
